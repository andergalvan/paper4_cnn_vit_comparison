...
if __name__ == '__main__':
    ...
    parser.add_argument("--rec_path", default='/home/ubuntu/Paper4_CNN_ViT_Comparison/CASIA-WebFace/setup_casia_webface/faces_webface_112x112', type=str)
    parser.add_argument("--save_path", default='/home/ubuntu/Paper4_CNN_ViT_Comparison/CASIA-WebFace/casia_webface/casia_webface', type=str)
