...
if __name__ == '__main__':
    ...
    parser.add_argument("--rec_path", default='/home/ubuntu/Paper4_CNN_ViT_Comparison/pretraining/setup_vggface2/faces_vgg_112x112', type=str)
    parser.add_argument("--save_path", default='/home/ubuntu/Paper4_CNN_ViT_Comparison/pretraining/vggface2', type=str)
