...
from utils import get_model, test_close, test_open_openmax, set_seed
...
for model_name in AVAILABLE_MODELS:
    ...
    for run_idx, seed in enumerate(SEEDS):
        ...
        osr_metrics = test_open_openmax(model, opentest_loader, DEVICE, weibull_models, NUM_CLASSES, class_names_open, WEIBULL_ALPHA, WEIBULL_THRESHOLD, WEIBULL_DISTANCE)
        print('\t\tEvaluation completed.')
        ...
        csv_path = os.path.join(model_run_results_path, 'evaluation_metrics_openmax.csv')
